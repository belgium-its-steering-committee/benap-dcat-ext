...
| description | Gives the user more information about the content of the dataset or service. This MUST be filled in all selected metadata languages. Can be added in multiple languages using @language. | true | dct:description | | |
