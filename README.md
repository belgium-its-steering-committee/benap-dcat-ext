...
| title (name of the dataset)| Describes the dataset in generic terms or gives a short description. The author is encouraged to write a meaningful description in one of the selected metadata language.  Can be added in multiple languages, see example [here](https://github.com/belgium-its-steering-committee/benap-dcat-ext/blob/main/examples/multilanguage.xml) or [here](https://github.com/belgium-its-steering-committee/benap-dcat-ext/blob/main/examples/multilanguage.ttl)| true | dct:title | | |
...
| visibility | Visibility of the dataset, published or private. defaults to private. | false |  | | [visibility](https://github.com/belgium-its-steering-committee/benap-dcat-ext/blob/main/vocabularies.md#visibility) |
